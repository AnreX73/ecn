# Generated by Django 4.1.4 on 2023-01-16 04:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='gallery2',
            name='galleryLink2',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ecn.outcityobject', verbose_name='Ссылка на объект'),
        ),
        migrations.AddField(
            model_name='gallery',
            name='galleryLink',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ecn.incityobject', verbose_name='Ссылка на объект'),
        ),
    ]
